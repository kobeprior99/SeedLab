 ...
 *        The robot then looks for the next marker, then turns and drives to it. If it arrives at a marker with no arrow it will stop
 *
 * @details
 ...
 * - Stops at the marker and either stays or turns based on red or green arrow at marker in which case it will turn the respective direction.
 *
